...
await writeFile(join(out,'build.json'),JSON.stringify({version:'3.0.0',index_sha256:manifest.index_sha256,semantic_sha256:manifest.semantic_sha256,files},null,2));
